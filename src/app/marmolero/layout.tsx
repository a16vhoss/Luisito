...
const bottomNavLinks = [
  { href: "/marmolero/asistencia", label: "Asistencia", icon: Clock },
  { href: "/marmolero/obra", label: "Piezas", icon: Hammer },
  { href: "/marmolero/instalaciones", label: "Instalación", icon: CheckSquare },
  { href: "/marmolero/asistencia", label: "Perfil", icon: UserCircle },
]

export default function MarmoleroLayout({
  children,
}: {
