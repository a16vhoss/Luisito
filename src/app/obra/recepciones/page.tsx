      ...
      <div className="px-5 pb-6">
        ...
        <div className="grid grid-cols-3 gap-2 py-4">
          <div className="rounded-xl border border-marble-200 bg-white px-3 py-3 text-center shadow-sm">
            <p className="text-lg font-bold text-semaforo-amarillo">1</p>
            <p className="text-[9px] font-medium tracking-wide text-marble-500">PENDIENTES</p>
          </div>
          <div className="rounded-xl border border-marble-200 bg-white px-3 py-3 text-center shadow-sm">
            <p className="text-lg font-bold text-semaforo-verde">2</p>
            <p className="text-[9px] font-medium tracking-wide text-marble-500">RECIBIDAS</p>
          </div>
          <div className="rounded-xl border border-marble-200 bg-white px-3 py-3 text-center shadow-sm">
            <p className="text-lg font-bold text-semaforo-rojo">1</p>
              ...
              >
                <div className="p-4">
                  ...
                  <div className="mt-2 flex flex-wrap gap-x-3 gap-y-1 text-[11px] text-marble-400">
                    ...
                    <span className="flex items-center gap-1">
                      <Package className="h-3 w-3" /> {rec.piezas} pzas &middot; {rec.m2} m²
                    </span>
                    <span className="flex items-center gap-1">
                ...
                {rec.estatus === "pendiente" && (
                  <div className="flex border-t border-marble-100">
                    <button className="flex flex-1 items-center justify-center gap-1.5 py-2.5 text-xs font-semibold text-semaforo-verde active:bg-semaforo-verde/5 transition-colors">
                      <CheckCircle2 className="h-3.5 w-3.5" />
                      Confirmar Recepción
                    </button>
                    <div className="w-px bg-marble-100" />
                    <button className="flex flex-1 items-center justify-center gap-1.5 py-2.5 text-xs font-semibold text-semaforo-rojo active:bg-semaforo-rojo/5 transition-colors">
