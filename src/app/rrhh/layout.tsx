          ...
          {!collapsed && (
            <Link href="/personal" className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#7A6D5A]">Recursos Humanos</p>
              </div>
            </Link>
          )}
          {collapsed && (
        ...
        <header className="flex h-16 items-center justify-between border-b border-[#E0DBD1] bg-white px-6">
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Buscar empleados, asistencias..."
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-right">
                <p className="text-sm font-medium text-[#1E1A14]">María Rodríguez</p>
                <p className="text-xs text-[#7A6D5A]">Recursos Humanos</p>
              </div>
            </div>
          </div>
        </header>
